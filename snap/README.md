 ...
 * security-token-file-provider
 * When

security-proxy-setupsecurity is enabled, Consul is secured using Vault for secret management, and Kong is used as an HTTPS proxy for all the services.
